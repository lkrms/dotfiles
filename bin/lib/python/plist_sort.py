...
Usage:
  plist_sort.py [<input-file> [<output-file> [<entry> [<sort-by-entry>]]]]

Reads from STDIN and writes to STDOUT if filenames are '-' or are not given.
Entry syntax is ':<entry>[:<entry>]...'. <sort-by-entry> must exist in each
<entry> if given.
