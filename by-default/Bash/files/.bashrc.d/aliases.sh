...
alias magick-pdf-a5="magick-get-pdf 120 160"
alias magick-pdf-a5-tight="magick-get-pdf 135 197"
...
alias open-webui-start="docker run -d -p 3000:8080 --add-host=host.docker.internal:host-gateway -v open-webui:/app/backend/data --name open-webui --restart always ghcr.io/open-webui/open-webui:main"
alias open-webui-update="docker rm -f open-webui && docker pull ghcr.io/open-webui/open-webui:main && open-webui-start"
